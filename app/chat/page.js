        ...
        >
          <div className="flex items-center justify-between">
            ...
            <div className="text-center">
              ...
              >
                {takeover ? "QQ 聊天" : "claw接管中"}
              </motion.p>
              <motion.h1
                layout
                className="mt-1 text-base font-black leading-6 text-slate-900 sm:text-lg"
              >
                {takeover ? "真人接管对话" : "AI 代聊记录"}
              </motion.h1>
            </div>
            <motion.div
              layout
            ...
            {!takeover && (
              ...
              >
                <p className="text-sm leading-6 text-slate-600">
                  当前气泡内容来自 AIclaw代理，不是双方真人本人。我们用机器人头像和独立标签标记，确保接管前后的身份边界足够清晰。
                </p>
              </motion.div>
            )}
          </AnimatePresence>
            ...
            >
              <div className="pointer-events-auto w-full max-w-md rounded-[1.8rem] bg-[linear-gradient(90deg,_#12a4ff,_#7fdcff,_#ffd66b)] p-[1px] shadow-[0_0_35px_rgba(18,164,255,0.35)]">
                <motion.button
                  ...
                  className="w-full rounded-[1.75rem] bg-slate-950/92 px-5 py-5 text-base font-black leading-6 text-white"
                >
                  有点意思，我来接管一下
                  <br />
                  以真人身份打个招呼
